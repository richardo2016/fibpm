...
export interface PackageJSON {
    ...
    os?: ('win32' | '!win32' | 'linux' | '!linux' | 'darwin' | '!darwin')[];
    cpu?: ('x64' | '!x64' | 'ia32' | '!ia32' | 'arm' | '!arm' | 'mips' | '!mips')[];
    private?: boolean;
    publishConfig?: {
        registry?: string;
    };
 ...
 */
export declare type UnpublishedPackageJSON = Omit<PackageJSON, 'name' | 'version'> & Partial<Pick<PackageJSON, 'name' | 'version'>>;
