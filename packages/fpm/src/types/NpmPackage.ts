 ...
 */
type NpmPackageInfoForExplorer = Pick<PackageJSON, 
    'name'
    | 'version'
    | 'description'
    | 'main'
...
export type NpmPackageInfoFromBrowser = Omit<NpmPackageIndexedCriticalInfo, 'versions'> & NpmPackageInfoForExplorer & {
    versions: {
        [formatted_semver_key: string]: NpmPackageInfoForExplorer & {
            /* npm specified fields, pointless in general :start */
            _id?: string
            _nodeVersion?: string
            _npmVersion?: string
            ...
            /* npm specified fields, pointless in general :end */
            [any_other_user_defined_key: string]: any
        }
    }
    time: {
