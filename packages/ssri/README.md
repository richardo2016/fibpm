...
[![NPM version](https://img.shields.io/npm/v/@fibpm/ssri.svg)](https://www.npmjs.org/package/@fibpm/ssri)
[![license](https://img.shields.io/npm/l/@fibpm/ssri.svg)](https://npm.im/@fibpm/ssri)

This is one migration of [`ssri`](https://github.com/npm/ssri), for Fibjs.

[`ssri`](https://github.com/richardo2016/fibpm/packages/ssri), short for Standard Subresource
